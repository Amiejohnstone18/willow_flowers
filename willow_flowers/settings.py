"""
Django settings for willow_flowers project.
...
SECRET_KEY = 'bqc#1-=efko&c#0x4s(d88jcwvl*js-#@7+3otsw3189v9fwh*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['willow-flowers.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'willow_flowers.urls'
